      ...
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-popup p-6 z-50" onClick={(e) => e.stopPropagation()}>
        ...
        {!editing ? (
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <div className="text-dark-gray font-semibold">{med.type === "prescription" ? "처방약" : "영양제"}</div>
            </div>
            <div>
          ...
          <form className="grid grid-cols-2 gap-4" onSubmit={onSave}>
            ...
            <div className="col-span-2 flex gap-3 mt-2">
              <button type="button" onClick={() => setEditing(false)} className="flex-1 py-3 border rounded-lg hover:bg-gray-100 text-gray-700">
                취소
              </button>
        ...
        {!editing && (
          <div className="flex gap-3 mt-6">
            <button onClick={startEditing} className="flex-1 bg-mint hover:bg-mint-dark text-white font-bold py-3 px-4 rounded-lg">
              수정
            </button>
            <button onClick={onDelete} className="flex-1 border border-red-300 text-red-500 hover:bg-red-50 font-bold py-3 px-4 rounded-lg">
              삭제
            </button>
          </div>
        )}
